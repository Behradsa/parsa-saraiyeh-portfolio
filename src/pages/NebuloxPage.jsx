    ...
    <div className={styles["page"]}>
      ...
      <div className={`${styles["main-container"]}`}>
        ...
        <section className={`${styles["introduction-section"]}`}>
          <div className={`${styles["flex-gap16"]}`}>
            <h2>Introduction</h2>
            <div className={`${styles["flex-gap8"]}`}>
              <p>
                Me and the team at Nebulox were tasked with designing a brand
                new product from scratch for an overarching brand consists of
                multiple sub brands and products that provides crypto payment
                solutions to other businesses. There was nothing to work off of
                in terms of brand identity and creative direction, not even a
                product name.
              </p>
              <p>My Role in the team: Visual Designer</p>
              <p>
                Design Team: We started with one lead designer and 1 product
                designer plus myself as the hands-on visual designer, but a
                little bit down the road we borrowed another product designer
                from another product team for couple of sprints in order to
                speed things up.
              </p>
              <p>Dev Team: x6 developers</p>
              <p>Product Team: x1 product manager, x1 product lead</p>
            </div>
          </div>
          <div className={`${styles["flex-gap16"]}`}>
            ...
            <div className={`${styles["flex-gap8"]}`}>
              <p>
                ...
                / trading platform that can cater to a wide range of users
                around the globe with hassle free KYC (Know Your Customer)
                processes and free access to the wider crypto community
                regardless of their location.
              </p>
              <p>
                First module that we were tasked to develop was a crypto payment
                gateway as a standalone product so we can generate revenue in
                order to build the rest of the modules. Crypto payment gateway
                was set to be a B2B product that empowers small to large
                businesses including entrepreneurs, medium and large sized
                organizations and enterprises to accept crypto as their payment
                method for their products and services.
              </p>
              <p>
                Building a brand new product from scratch is always challenging
          ...
          <div className={`${styles["flex-gap16"]}`}>
            ...
            <div>
              <ul>
                ...
                <li>
                  Giving product design team direction, processes and proper
                  tooling in order to deliver their best work possible
                </li>
                <li>
                  Managing and delegating incoming work load and assigning tasks
                  to team members
                </li>
              </ul>
            </div>
          ...
          <div className={`${styles["flex-gap16"]}`}>
            ...
            <div className={`${styles["flex-gap8"]}`}>
              ...
              <ul>
                <li>
                  Brand Identity including name, logo, style guides, UI
              ...
              <ul>
                ...
                <li>
                  More static pages including cookie policy, invoice landing
          ...
          <div className={`${styles["flex-gap32"]}`}>
            <h3>Challenges</h3>
            <div className={`${styles["flex-gap16"]}`}>
              <div className={`${styles["flex-gap16"]}`}>
                <div className={`${styles["flex-gap8"]}`}>
                  <h4>No Vision, No Roadmap</h4>
                  <p>
                    One of the biggest challenges we’ve had initially was not
                    having a product mission and vision along with any product
                    roadmap so it was difficult to align the product design team
                    with the executive management. It also made it difficult for
                    us when we were trying to get a grasp of the product scope
                    and future requirements.
                  </p>
                  <p>
                    In order to rectify the situation, I’ve conducted multiple
                    workshops with the PM and the product lead regarding product
                    scoping and roadmap and we were able to land on a roadmap,
                    vision and mission of our new product.
                  </p>
                </div>
                <div className={`${styles["flex-gap8"]}`}>
                  <h4>Time Constraints</h4>
                  <p>
                    Another challenge was the fact that we needed to get things
                    done in the shortest time possible.
                  </p>
                  <p>
                    We made a decision to borrow another product designer to get
                    things rolling. As designers, we are very familiar with
                    tight deadlines but sometimes we have to use some creative
                    problem solving to get the result we are after even in terms
                    of the team structure.
                  </p>
                </div>
                <div className={`${styles["flex-gap8"]}`}>
                  <h4>Wide Range of User Demographics</h4>
                  <p>
                    This product must be easy to use and cater to the needs of
                    both our direct clients, meaning businesses (called
                    merchants) and their users (called merchant’s customers)
                    which means there’s a wide range of users from tech savvy
                    and crypto experts to casuals who just want to use crypto
                    for payment purposes.
                  </p>
                  <p>
                    We planned for a design that is inclusive and does a lot of
                    hand-holding in our onboarding process, empty states and the
                    way we convey important information like transaction fees
                    and network fees and decisions like choosing proper network
                    when a merchant or their customers transferring money.
                  </p>
                </div>
                <div>
                  <h4>Scalability</h4>
                  <p>
                    It is crucial yet challenging to stay ahead of the ever
                    changing crypto ecosystem as it is very new and there are a
                    lot of things to consider and prepare for.
                  </p>
                  <p>
                    We decided to go for a modular design approach in terms of
                    our solutions which had an impact on everything we were
                    doing in our day to day design activities from building a
                    simple component to more UX heavy artifacts and decisions
                    like user flows and information architecture.
                  </p>
                </div>
                <p>
                  Thanks to the design system we’ve developed for the
                  organization a little bit before this, product design team had
                  a structure to lay their style guide and components on top of
                  a solid foundation which helped us immensely particularly with
